...
public class EvaluatorDispatch implements OpVisitor {
    ...
    public void visit(OpService opService) {
        ServiceQueryExecutionCache cache = new ServiceQueryExecutionCache(); //create a new request-scope cache 
        QueryIterator qIter = Service.exec(opService, ARQ.getContext(), cache);
