...
import com.hp.hpl.jena.sparql.engine.http.ServiceQueryExecutionCache;
...
/**
 * This class has been extended for supporting a request-score cache that stores
 * pairs of (uri, query) in order to avoid unnecessary SERVICE invocations.
...
public class QueryIterService extends QueryIterRepeatApply {
    ...
    OpService opService;
    ServiceQueryExecutionCache cache; //request-scope cache for storing pairs of (uri, query)
    ...
    public QueryIterService(QueryIterator input, OpService opService, ExecutionContext context) {
        ...
        cache = new ServiceQueryExecutionCache();
    }
    ...
    protected QueryIterator nextStage(Binding outerBinding) {
        ...
        QueryIterator qIter;
        try {
            qIter = Service.exec((OpService) op, getExecContext().getContext(), cache);
