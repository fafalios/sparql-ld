...
import com.hp.hpl.jena.sparql.engine.http.EndpointsIndex;
import com.hp.hpl.jena.sparql.engine.http.QueryEngineHTTP;
import com.hp.hpl.jena.sparql.engine.http.ResourcesCache;
...
public class QueryExecutionFactory {
    ...
    /**
     * Request-scope cache of the already-retrieved resources/datasets.
     */
    ...
    /**
     * Create a QueryExecution to execute over the Model, given some initial
     * values of variables.
     *
     * @param query Query
     * @param model Target of the query
     ...
     * class, {@link QueryEngineHTTP}, allows various HTTP specific parameters
     * to be set.
     *
